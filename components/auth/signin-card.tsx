...
export function SignInCard() {
  ...
  return (
    <div className="flex size-full flex-col items-center justify-center">
      ...
      <p className="text-center font-goldman text-2xl sm:text-3xl">
        Welcome to{" "}
      ...
      <div className="mt-8 flex w-full max-w-sm flex-col gap-3">
        ...
        <div className="relative w-full">
          ...
          <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-background px-3 font-goldman text-default-400">
            OR
          </span>
        </div>
        <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-2">
          ...
          <div className="flex w-full justify-end">
            <Link href="/auth/forgot-password" as={NextLink}>
              Forgot password?
            </Link>
          </div>
          ...
          <Button
            type="submit"
            color="primary"
            className="w-full bg-gradient-to-r from-[#2D79FF] to-[#22B4FD] font-goldman"
            isLoading={loading}
          >
            Sign In
          </Button>
        ...
        <div className="mt-8 w-full max-w-sm space-y-4">
          <p className="text-center">
            ...
            <Link
              href="/auth/signup"
              className="bg-gradient-to-r from-[#2D79FF] to-[#22B4FD] bg-clip-text font-goldman text-transparent"
              as={NextLink}
            >
              Register
            </Link>
